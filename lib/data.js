...
export const profile = {
  ...
  formspreeId: "https://formspree.io/f/mnjkleza",
};
...
export const projects = [
  {
    ...
    description:
      "A modern restaurant website featuring menu browsing, an inviting brand experience, and a responsive interface designed to drive reservations and online engagement.",
  ...
  {
    name: "AfroChat",
    type: "AI-Supported Chat Platform",
    description:
      "Contributed to backend systems powering AI-driven communication features — designing APIs and data pipelines for AI model integration with a focus on scalability and performance.",
    tags: ["Python", "AI Integration", "APIs", "Data Pipelines"],
    live: null,
  },
  {
